...
(function(){
					...
					$(".comments-list").append(`
						<div class="media">
	                		<a class="media-left" href="#">
	                    		<img src="${data[i].profileImg}" alt="" class="rounded-circle">
	                    	</a>
	...
	$("#btnBuy").click(async function(e){
		...
		let safetyTradeYn = $("input[name=safetyTradeYn]").val();
		...
		if(safetyTradeYn == "N"){
			alert("해당 상품은 안전결제상품이 아닙니다.\n판매자와 연락 후 구매진행해주시기 바립니다.");
			return;
		}
